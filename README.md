...
Готовый jar: `build/libs/nhack-<version>.jar` (сейчас `nhack-1.0.7.jar`)
...
только ближайшие к игроку 20, иначе экран тонет в метках, а рендер кладёт FPS. Настройки: `Radius`, `MaxY`,
`MaxPerChunk`, `DiamondColor`.
